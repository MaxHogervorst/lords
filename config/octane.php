...
return [
    ...
    */
    ...
    | quickly accessible by other workers on the particular Swoole server.
    |
    */
    ...
    */
    ...
    | collection if memory consumption exceeds the following threshold.
    |
    */
    ...
    | being handled by Octane. You are free to set this value to meet your
    | application's requirements. By default, we will wait 30 seconds.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Here you may define various configuration options that are specific to
    | the Swoole server implementation that is being utilized by Octane on
    | your local machine or in production. All options are optional here.
    |
    */
    ...
    |
    | Here you may define various configuration options that are specific to
    | the RoadRunner server implementation that is being utilized by Octane
    | on your machine or in production. All options are optional for you.
    |
    */
